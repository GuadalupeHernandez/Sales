...
Product.create name: 'Iphone', description:'Um Iphone 7 ...', status: :active, price: 10
Product.create name: 'Ipad', description:'Um tablet marca apple ...', status: :active, price: 20
